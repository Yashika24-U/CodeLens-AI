...
const {
  getDashboardStats,
} = require("../controllers/chat/analyticsController");
const { handleUserPrompt } = require("../controllers/chat/chatController");
const { getUserConversation } = require("../controllers/chat/chatController");
...
router.get("/conversations/:id/messages", getUserConversation);
